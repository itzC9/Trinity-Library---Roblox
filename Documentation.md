# Trinity Library
This documentation is for the stable release of Trinity Library.

## Booting the Library
```lua
local TrinityLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/itzC9/Loader/refs/heads/main/LoadInt.lua')))()
```


## Creating a Window
```lua
local Window = TrinityLib:MakeWindow({Name = "Title of the library", HidePremium = false, IntroText = "Darkwire Hub", Draggable = true, SaveConfig = true, ConfigFolder = "TrinityTest"})
...
print(TrinityLib.Flags["toggle"].Value) -- prints the value of the toggle.
```
...
## ADDITIONAL SCRIPT
```local ClockSection = Home:AddSection({Name = "Current Date and Time"})
